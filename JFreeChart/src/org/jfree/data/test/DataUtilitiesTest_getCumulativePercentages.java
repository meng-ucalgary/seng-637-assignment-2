...
public class DataUtilitiesTest_getCumulativePercentages {
	...
	public void getCumulativePercentagesWithNoKeyedValues() {
        ...
        assertEquals("Calling getCumulativePercentage on an empty KeyedValues, should return an empty KeyedValues object", expected, cumPercentage);
    }
    ...
    public void getCumulativePercentagesWithOneKeyedValueHavingZeroValue() {
        ...
        assertEquals("The cumulative percentage of 0 in data should be the result of 0.0/0.0", 0.0/0.0, result.getValue(0));
    }
    ...
    public void getCumulativePercentagesWithKeyedValuesHavingNullAndMixValues() {
        ...
        assertEquals("The cumulative percentage of -4.5 in data should be -0.45", -0.45, result.getValue(0).doubleValue(), 0.000000001d);
        assertEquals("The cumulative percentage of 2 in data should be -0.25", -0.25, result.getValue(1).doubleValue(), 0.000000001d);
        assertEquals("The cumulative percentage of null in data should be -0.25", -0.25, result.getValue(2).doubleValue(), 0.000000001d);
        assertEquals("The cumulative percentage of 12.5 in data should be 1.0", 1.0, result.getValue(3).doubleValue(), 0.000000001d);
        assertEquals("The cumulative percentage of 0 in data should be 1.0", 1.0, result.getValue(4).doubleValue(), 0.000000001d);
    }
